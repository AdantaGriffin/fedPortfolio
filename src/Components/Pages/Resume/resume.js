        ...
        <>
            {/*<section className={styles.resume}>
                <section className={styles.resumeHeader}>
                    ...
                    <p>email: adantagriffin90@gmail.com | phone: 718.820.2506</p>
                    <p><img height="20px" width="20px" src="/github.png" alt="icon"/>: <a href='/'>github.com/AdantaGriffin</a></p> 
                    <p><img height="20px" width="20px" src="/netlify.png" alt="icon"/>: <a href='/'>adantag.netlify.app</a></p>
                    <p><img height="20px" width="20px" src="/social.png" alt="icon"/>: <a href='/'>linkedin.com/in/adanta-griffin</a></p>
                </section>

                <section className={styles.resumeSummary}>
                    <h2>Summary</h2>
                    <hr></hr>
                    <p>I'm an entry level Web Developer with experience building responsive applications using HTML, CSS, JavaScript, React, . Passionate about creating user-friendly interfaces and continuously learning modern web technologies.</p>
                </section>
                ...
                <section className={styles.resumeSkills}>
                    ...
                    <h2>Tools</h2>
                    <hr></hr>
                    <p>Git, GitHub, VS Code, Chrome DevTools, Responsive Design, REST API</p>
                </section>
                ...
                <section className={styles.resumeCertifications}>
                    <div className={styles.certContainer}>
                        <img className={styles.certImage} src="" alt="certification"/>
                        <img className={styles.certImage} src="" alt="certification"/>
                        <img className={styles.certImage} src="" alt="certification"/>
                        <img className={styles.certImage} src="" alt="certification"/>
                        <img className={styles.certImage} src="" alt="certification"/>
